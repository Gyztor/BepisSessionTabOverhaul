...
2. Download the latest release ZIP file (e.g., `GyztorMizirath-SessionTabOverhaul-X.zip`) from the [Releases](https://github.com/Gyztor/BepisSessionTabOverhaul/releases) page.
...
[NepuShiro](https://github.com/NepuShiro) - Some of the updates to the orginal one to be more compat with current reso and general improvements.

[Banane9](https://github.com/Banane9) - Original mod that was orginally for Neos.